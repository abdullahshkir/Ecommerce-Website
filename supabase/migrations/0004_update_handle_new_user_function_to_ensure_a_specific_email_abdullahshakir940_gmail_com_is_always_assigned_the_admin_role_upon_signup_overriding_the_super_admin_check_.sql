...
BEGIN
  ...
  -- 3. Override: If the email is the designated Super Admin email, assign 'admin' role
  IF new.email = 'abdullahshakir940@gmail.com' THEN
    user_role := 'admin';
  END IF;

  -- 4. Insert the profile with the determined role
