    ...
    return (
        <div className="p-6 bg-white rounded-lg border">
            ...
            <p className="text-gray-600 mb-6">
                Hello, <span className="font-semibold text-gray-800">{user?.displayName || 'Customer'}</span>! From your account dashboard you can view your{' '}
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    {recentOrder ? (
                        <div>
                            <p className="text-sm text-gray-500">Order #{recentOrder.id} - {recentOrder.status}</p>
                            <p className="text-sm text-gray-500">{recentOrder.date}</p>
                        </div>
                    ) : (
